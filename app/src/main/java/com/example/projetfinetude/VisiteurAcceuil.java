...
public class VisiteurAcceuil extends AppCompatActivity implements OnMapReadyCallback {
final static float DEFAULT_ZOOM=7;
    final static float REGION_ZOOM=8.5f;
ImageView btn_map1,btn_map2;
    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_visiteur_acceuil);
       ...
       googleMap.addMarker(optionBizert);       googleMap.addMarker(optionTunis);       googleMap.addMarker(optionJandouba);
                                ...
                                public boolean onMarkerClick(Marker marker) {
                                    switch (marker.getTitle()){
                                        case "Cap Serat":
                                        {
                                            ...
                                            intent.putExtra("useruid","Visiteur");
                                            Toast.makeText(VisiteurAcceuil.this, ""+direction, Toast.LENGTH_SHORT).show();
                                            Toast.makeText(VisiteurAcceuil.this, "useruid\n null", Toast.LENGTH_SHORT).show();
        ...
        btn_map1.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                Toast.makeText(VisiteurAcceuil.this, "Mode:SATELLITE", Toast.LENGTH_SHORT).show();
            }
        });
        btn_map2.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                Toast.makeText(VisiteurAcceuil.this, "Mode:HYBRID", Toast.LENGTH_SHORT).show();
