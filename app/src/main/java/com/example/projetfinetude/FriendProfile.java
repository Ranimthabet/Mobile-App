...
public class FriendProfile extends AppCompatActivity {
   ...
   String email,phone,birthdate,userkey,userUri,username;
    ...
    ImageView logo_agenda,logo_tlfn,logo_adress,logo_msg,logo_bloc;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        logo_msg=findViewById(R.id.friendmsg);
        logo_bloc=findViewById(R.id.friendbloc);
        logo_msg.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Toast.makeText(FriendProfile.this, "Yoou can send msg", Toast.LENGTH_SHORT).show();
            }
        });
        logo_bloc.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Toast.makeText(FriendProfile.this, "Yoou can bloc user", Toast.LENGTH_SHORT).show();
            }
        });

        logo_agenda.setColorFilter(Color.YELLOW);
        logo_tlfn=findViewById(R.id.ic_prflagenda);
        logo_tlfn.setColorFilter(Color.YELLOW);
        logo_adress=findViewById(R.id.ic_prflemail);
        logo_adress.setColorFilter(Color.YELLOW);
        ...
        logo_msg.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                intent.putExtra("reciveruid",userkey);
                intent.putExtra("recivername",username);
                intent.putExtra("reciverimage",userUri);
       ...
       UserRef = FirebaseDatabase.getInstance().getReference().child("User").child(userkey);
        ...
        UserRef.addValueEventListener(new ValueEventListener() {
           ...
           if(snapshot.exists()){
               ...
               Toast.makeText(FriendProfile.this, "Verifie votre db", Toast.LENGTH_SHORT).show();
           }
